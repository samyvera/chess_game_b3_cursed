    ...
    constructor(id, role) {
        ...
        this.createArmy = () => {
            ...
            if (this.role === "player1") {
                ...
                army.push(new Piece("king", new Vector2D(4, 0)));
                army.push(new Piece("queen", new Vector2D(3, 0)));
                ...
                army.push(new Piece("king", new Vector2D(4, 7)));
                army.push(new Piece("queen", new Vector2D(3, 7)));
